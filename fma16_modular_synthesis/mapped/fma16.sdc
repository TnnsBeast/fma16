...
# Created by write_sdc on Mon Apr 28 21:53:27 2025
...
set_driving_cell -lib_cell sky130_osu_sc_12T_ms__dff_1 -pin Q [get_ports       \
{z[0]}]
set_driving_cell -lib_cell sky130_osu_sc_12T_ms__dff_1 -pin Q [get_ports mul]
set_driving_cell -lib_cell sky130_osu_sc_12T_ms__dff_1 -pin Q [get_ports add]
set_driving_cell -lib_cell sky130_osu_sc_12T_ms__dff_1 -pin Q [get_ports negp]
set_driving_cell -lib_cell sky130_osu_sc_12T_ms__dff_1 -pin Q [get_ports negz]
set_driving_cell -lib_cell sky130_osu_sc_12T_ms__dff_1 -pin Q [get_ports       \
{roundmode[1]}]
set_driving_cell -lib_cell sky130_osu_sc_12T_ms__dff_1 -pin Q [get_ports       \
{roundmode[0]}]
...
set_load -pin_load 0.00278109 [get_ports {flags[3]}]
set_load -pin_load 0.00278109 [get_ports {flags[2]}]
set_load -pin_load 0.00278109 [get_ports {flags[1]}]
set_load -pin_load 0.00278109 [get_ports {flags[0]}]
...
set_max_fanout 6 [get_ports negp]
...
set_input_delay -clock clk  -max 0  [get_ports {x[15]}]
set_input_delay -clock clk  -max 0  [get_ports {x[14]}]
set_input_delay -clock clk  -max 0  [get_ports {x[13]}]
set_input_delay -clock clk  -max 0  [get_ports {x[12]}]
set_input_delay -clock clk  -max 0  [get_ports {x[11]}]
set_input_delay -clock clk  -max 0  [get_ports {x[10]}]
set_input_delay -clock clk  -max 0  [get_ports {x[9]}]
set_input_delay -clock clk  -max 0  [get_ports {x[8]}]
set_input_delay -clock clk  -max 0  [get_ports {x[7]}]
set_input_delay -clock clk  -max 0  [get_ports {x[6]}]
set_input_delay -clock clk  -max 0  [get_ports {x[5]}]
set_input_delay -clock clk  -max 0  [get_ports {x[4]}]
set_input_delay -clock clk  -max 0  [get_ports {x[3]}]
set_input_delay -clock clk  -max 0  [get_ports {x[2]}]
set_input_delay -clock clk  -max 0  [get_ports {x[1]}]
set_input_delay -clock clk  -max 0  [get_ports {x[0]}]
set_input_delay -clock clk  -max 0  [get_ports {y[15]}]
set_input_delay -clock clk  -max 0  [get_ports {y[14]}]
set_input_delay -clock clk  -max 0  [get_ports {y[13]}]
set_input_delay -clock clk  -max 0  [get_ports {y[12]}]
set_input_delay -clock clk  -max 0  [get_ports {y[11]}]
set_input_delay -clock clk  -max 0  [get_ports {y[10]}]
set_input_delay -clock clk  -max 0  [get_ports {y[9]}]
set_input_delay -clock clk  -max 0  [get_ports {y[8]}]
set_input_delay -clock clk  -max 0  [get_ports {y[7]}]
set_input_delay -clock clk  -max 0  [get_ports {y[6]}]
set_input_delay -clock clk  -max 0  [get_ports {y[5]}]
set_input_delay -clock clk  -max 0  [get_ports {y[4]}]
set_input_delay -clock clk  -max 0  [get_ports {y[3]}]
set_input_delay -clock clk  -max 0  [get_ports {y[2]}]
set_input_delay -clock clk  -max 0  [get_ports {y[1]}]
set_input_delay -clock clk  -max 0  [get_ports {y[0]}]
set_input_delay -clock clk  -max 0  [get_ports {z[15]}]
set_input_delay -clock clk  -max 0  [get_ports {z[14]}]
set_input_delay -clock clk  -max 0  [get_ports {z[13]}]
set_input_delay -clock clk  -max 0  [get_ports {z[12]}]
set_input_delay -clock clk  -max 0  [get_ports {z[11]}]
set_input_delay -clock clk  -max 0  [get_ports {z[10]}]
set_input_delay -clock clk  -max 0  [get_ports {z[9]}]
set_input_delay -clock clk  -max 0  [get_ports {z[8]}]
set_input_delay -clock clk  -max 0  [get_ports {z[7]}]
set_input_delay -clock clk  -max 0  [get_ports {z[6]}]
set_input_delay -clock clk  -max 0  [get_ports {z[5]}]
set_input_delay -clock clk  -max 0  [get_ports {z[4]}]
set_input_delay -clock clk  -max 0  [get_ports {z[3]}]
set_input_delay -clock clk  -max 0  [get_ports {z[2]}]
set_input_delay -clock clk  -max 0  [get_ports {z[1]}]
set_input_delay -clock clk  -max 0  [get_ports {z[0]}]
set_input_delay -clock clk  -max 0  [get_ports mul]
set_input_delay -clock clk  -max 0  [get_ports add]
set_input_delay -clock clk  -max 0  [get_ports negp]
set_input_delay -clock clk  -max 0  [get_ports negz]
set_input_delay -clock clk  -max 0  [get_ports {roundmode[1]}]
set_input_delay -clock clk  -max 0  [get_ports {roundmode[0]}]
...
set_output_delay -clock clk  -max 0  [get_ports {flags[3]}]
set_output_delay -clock clk  -max 0  [get_ports {flags[2]}]
set_output_delay -clock clk  -max 0  [get_ports {flags[1]}]
set_output_delay -clock clk  -max 0  [get_ports {flags[0]}]
